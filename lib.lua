...
local Library do
    ...
    local Themes = {
        ["Preset"] = {
            ...
            ["Border"] = FromRGB(103, 103, 115),
            ["Inline"] = FromRGB(20, 24, 21),
            ["Hovered Element"] = FromRGB(37, 42, 45),
            ["Page Background"] = FromRGB(3, 96, 33),
            ["Outline"] = FromRGB(32, 53, 41),
    ...
    local Instances = { } do
        ...
        Instances.MakeDraggable = function(self)
            ...
            local Set = function(Input)
                ...
                self:Tween(TweenInfo.new(0.4, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Position = UDim2New(StartPosition.X.Scale, StartPosition.X.Offset + DragDelta.X, StartPosition.Y.Scale, StartPosition.Y.Offset + DragDelta.Y)})
            end
    ...
    local Components = { } do
        ...
        Components.Toggle = function(self, Data)
            ...
            Items["Toggle"]:OnHover(function()
                ...
                Items["Indicator"]:Tween(TweenInfo.new(0.2, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {
        ...
        Components.Slider = function(self, Data)
            ...
            function Slider:Set(Value)
                ...
                -- Enhanced slider animation with ultra-smooth easing for dragging
                local targetSize = UDim2New((Slider.Value - Data.Min) / (Data.Max - Data.Min), 0, 1, 0)
                local tweenInfo = TweenInfo.new(Slider.Sliding and 0.1 or 0.15, Enum.EasingStyle.Quint, Enum.EasingDirection.Out)
                Items["Accent"]:Tween(tweenInfo, {Size = targetSize})
    ...
    Library.Window = function(self, Data)
        ...
        function Window:SetOpen(Bool)
            ...
            if Window.IsOpen then 
                ...
                -- Start centered for smooth appearance
                Items["Window"].Instance.Position = UDim2.new(0.5, 0, 0.5, 0)
            else
                -- Slide out to top when closing
                local targetPosition = UDim2.new(0.5, 0, -0.1, 0)
                Items["Window"]:Tween(TweenInfo.new(0.3, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Position = targetPosition})
            end
            ...
            -- No position tween needed when opening since it starts centered
